...
function validateForm(event) {
  ...
  function togglePaymentDetails(e) {
    ...
    const creditCardContainer = document.querySelector(".credit_card");
    ...
    theForm.elements["credit"].removeAttribute("required");
    theForm.elements["paypal"].removeAttribute("required");
  
    // Show the container based on the selected payment method, and add the required attribute back.
    if (theForm.payment.value === "none") {
      return;
    } else if (theForm.payment.value === "credit") {
      creditCardContainer.classList.remove("hide");
      theForm.elements["credit"].setAttribute("required", "required");
    } else if (theForm.payment.value === "paypal") {
      paypalContainer.classList.remove("hide");
      theForm.element["paypal"].setAttribute("required", "required");
    }
